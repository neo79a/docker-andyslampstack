...
RUN apt-get update
RUN apt-get install -y apt-utils imagemagick zip fail2ban curl vim mysql-client supervisor cron npm
...
RUN apt-get install -y apt-utils zip apache2 apache2-doc apache2-utils ssl-cert libapache2-mod-php mysql-client net-tools pdftk
